...
#
# Script generated by Vivado on Thu Oct 03 23:52:59 -0700 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : fir_TOP_0.sh
...
#
# Usage        : fir_TOP_0.sh
#                fir_TOP_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_TOP_0.sh [-reset_run]
#                fir_TOP_0.sh [-reset_log]
#                fir_TOP_0.sh [-help]
#
...
#                script (type 'fir_TOP_0.sh -help' for more information).
#
...
# script info
echo -e "fir_TOP_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_TOP_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../export.gen/sources_1/ip/fir_TOP_0/drivers/fir_TOP_v1_0/src" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fir_TOP_0 xil_defaultlib.glbl -o fir_TOP_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fir_TOP_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fir_TOP_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fir_TOP_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fir_TOP_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fir_TOP_0.sh [-help]\n\
Usage: fir_TOP_0.sh [-step]\n\
Usage: fir_TOP_0.sh [-lib_map_path]\n\
Usage: fir_TOP_0.sh [-reset_run]\n\
Usage: fir_TOP_0.sh [-reset_log]\n\
Usage: fir_TOP_0.sh [-keep_index]\n\
Usage: fir_TOP_0.sh [-noclean_files]\n\n\
