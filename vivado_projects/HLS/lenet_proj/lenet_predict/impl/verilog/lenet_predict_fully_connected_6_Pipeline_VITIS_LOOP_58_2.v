...
module lenet_predict_fully_connected_6_Pipeline_VITIS_LOOP_58_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [0:0] grp_fu_253_p_opcode;
...
reg   [6:0] j_3_reg_249;
reg   [6:0] j_3_reg_249_pp0_iter1_reg;
reg   [6:0] j_3_reg_249_pp0_iter2_reg;
...
wire   [63:0] j_cast4_fu_218_p1;
wire  signed [63:0] sext_ln59_fu_197_p1;
reg   [31:0] sum_02_fu_64;
reg   [31:0] ap_sig_allocacmp_sum_02_load;
wire    ap_loop_init;
reg   [6:0] j_fu_68;
wire   [6:0] add_ln58_fu_175_p2;
...
wire  signed [62:0] sext_ln57_cast_fu_143_p1;
wire   [62:0] add_ln59_2_fu_191_p2;
...
assign add_ln58_fu_175_p2 = (ap_sig_allocacmp_j_3 + 7'd1);

assign add_ln59_2_fu_191_p2 = ($signed(add_ln59_fu_185_p2) + $signed(sext_ln57_cast_fu_143_p1));
...
assign grp_fu_253_p_ce = grp_fu_133_ce;

assign grp_fu_253_p_din0 = ap_sig_allocacmp_sum_02_load;

assign grp_fu_253_p_din1 = mul9_reg_293;

assign grp_fu_253_p_opcode = 2'd0;

assign grp_fu_257_p_ce = grp_fu_138_ce;

assign grp_fu_257_p_din0 = input_r_q0;

assign grp_fu_257_p_din1 = bitcast_ln59_fu_222_p1;

assign icmp_ln58_fu_169_p2 = ((ap_sig_allocacmp_j_3 == 7'd120) ? 1'b1 : 1'b0);

assign ifzero_fu_207_p2 = ((add_ln58_fu_175_p2 == 7'd120) ? 1'b1 : 1'b0);

assign input_r_address0 = j_cast4_fu_218_p1;

assign j_cast4_fu_218_p1 = j_3_reg_249_pp0_iter2_reg;

assign j_cast_fu_181_p1 = ap_sig_allocacmp_j_3;
...
assign output_r_d0 = grp_fu_253_p_dout0;

assign sext_ln56_cast_fu_147_p1 = $signed(sext_ln56);

assign sext_ln57_cast_fu_143_p1 = $signed(sext_ln57);

assign sext_ln59_fu_197_p1 = $signed(add_ln59_2_fu_191_p2);

assign zext_ln56_cast_fu_151_p1 = zext_ln56;

endmodule //lenet_predict_fully_connected_6_Pipeline_VITIS_LOOP_58_2
