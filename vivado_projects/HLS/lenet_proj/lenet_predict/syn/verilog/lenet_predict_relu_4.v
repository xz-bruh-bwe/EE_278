...
wire   [0:0] icmp_ln89_1_fu_120_p2;
...
assign add_ln87_fu_81_p2 = (ap_sig_allocacmp_i_3 + 7'd1);
...
assign icmp_ln87_fu_75_p2 = ((ap_sig_allocacmp_i_3 == 7'd84) ? 1'b1 : 1'b0);

assign icmp_ln89_1_fu_120_p2 = ((trunc_ln89_fu_110_p1 == 23'd0) ? 1'b1 : 1'b0);
...
assign or_ln89_fu_126_p2 = (icmp_ln89_fu_114_p2 | icmp_ln89_1_fu_120_p2);

assign tmp_fu_100_p4 = {{bitcast_ln89_fu_97_p1[30:23]}};

assign trunc_ln89_fu_110_p1 = bitcast_ln89_fu_97_p1[22:0];

assign zext_ln87_fu_87_p1 = ap_sig_allocacmp_i_3;

endmodule //lenet_predict_relu_4
