set moduleName softmax_Pipeline_VITIS_LOOP_75_2
set isTopModule 0
...
set C_modelName {softmax_Pipeline_VITIS_LOOP_75_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r float 32 regular {array 10 { 2 3 } 1 1 }  }
	{ max_val_reload float 32 regular  }
	{ sum_exp_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "max_val_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sum_exp_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ max_val_reload sc_in sc_lv 32 signal 1 } 
	{ sum_exp_out sc_out sc_lv 32 signal 2 } 
	{ sum_exp_out_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_val_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_val_reload", "role": "default" }} , 
 	{ "name": "sum_exp_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_exp_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fexp_32ns_32ns_32_6_full_dsp_1_U102", "Parent" : "0"},
...
set Spec2ImplPortList { 
	input_r { ap_memory {  { input_r_address0 mem_address 1 4 }  { input_r_ce0 mem_ce 1 1 }  { input_r_we0 mem_we 1 1 }  { input_r_d0 mem_din 1 32 }  { input_r_q0 in_data 0 32 } } }
	max_val_reload { ap_none {  { max_val_reload in_data 0 32 } } }
	sum_exp_out { ap_vld {  { sum_exp_out out_data 1 32 }  { sum_exp_out_ap_vld out_vld 1 1 } } }
}
