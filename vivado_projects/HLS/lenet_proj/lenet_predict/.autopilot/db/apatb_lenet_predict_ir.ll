; ModuleID = 'C:/Users/Baron/Desktop/EE_278_Repo/EE_278/vivado_projects/HLS/lenet_proj/lenet_predict/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_lenet_predict_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" "maxi" %input, i32* noalias nocapture nonnull %predicted_class, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="150" "maxi" %conv1_filters, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="6" "maxi" %conv1_bias, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="2400" "maxi" %conv2_filters, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" "maxi" %conv2_bias, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="48000" "maxi" %fc1_weights, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="120" "maxi" %fc1_bias, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="10080" "maxi" %fc2_weights, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="84" "maxi" %fc2_bias, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="840" "maxi" %fc3_weights, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="10" "maxi" %fc3_bias) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 4096)
  %input_copy = bitcast i8* %malloccall to [1024 x float]*
  %predicted_class_copy = alloca i32, align 512
  %conv1_filters_copy = alloca [150 x float], align 512
  %conv1_bias_copy = alloca [6 x float], align 512
  %malloccall1 = tail call i8* @malloc(i64 9600)
  %conv2_filters_copy = bitcast i8* %malloccall1 to [2400 x float]*
  %conv2_bias_copy = alloca [16 x float], align 512
  %malloccall2 = tail call i8* @malloc(i64 192000)
  %fc1_weights_copy = bitcast i8* %malloccall2 to [48000 x float]*
  %fc1_bias_copy = alloca [120 x float], align 512
  %malloccall3 = tail call i8* @malloc(i64 40320)
  %fc2_weights_copy = bitcast i8* %malloccall3 to [10080 x float]*
  %fc2_bias_copy = alloca [84 x float], align 512
  %fc3_weights_copy = alloca [840 x float], align 512
  %fc3_bias_copy = alloca [10 x float], align 512
  %0 = bitcast float* %input to [1024 x float]*
  %1 = bitcast float* %conv1_filters to [150 x float]*
  %2 = bitcast float* %conv1_bias to [6 x float]*
  %3 = bitcast float* %conv2_filters to [2400 x float]*
  %4 = bitcast float* %conv2_bias to [16 x float]*
  %5 = bitcast float* %fc1_weights to [48000 x float]*
  %6 = bitcast float* %fc1_bias to [120 x float]*
  %7 = bitcast float* %fc2_weights to [10080 x float]*
  %8 = bitcast float* %fc2_bias to [84 x float]*
  %9 = bitcast float* %fc3_weights to [840 x float]*
  %10 = bitcast float* %fc3_bias to [10 x float]*
  call fastcc void @copy_in([1024 x float]* nonnull %0, [1024 x float]* %input_copy, i32* nonnull %predicted_class, i32* nonnull align 512 %predicted_class_copy, [150 x float]* nonnull %1, [150 x float]* nonnull align 512 %conv1_filters_copy, [6 x float]* nonnull %2, [6 x float]* nonnull align 512 %conv1_bias_copy, [2400 x float]* nonnull %3, [2400 x float]* %conv2_filters_copy, [16 x float]* nonnull %4, [16 x float]* nonnull align 512 %conv2_bias_copy, [48000 x float]* nonnull %5, [48000 x float]* %fc1_weights_copy, [120 x float]* nonnull %6, [120 x float]* nonnull align 512 %fc1_bias_copy, [10080 x float]* nonnull %7, [10080 x float]* %fc2_weights_copy, [84 x float]* nonnull %8, [84 x float]* nonnull align 512 %fc2_bias_copy, [840 x float]* nonnull %9, [840 x float]* nonnull align 512 %fc3_weights_copy, [10 x float]* nonnull %10, [10 x float]* nonnull align 512 %fc3_bias_copy)
  call void @apatb_lenet_predict_hw([1024 x float]* %input_copy, i32* %predicted_class_copy, [150 x float]* %conv1_filters_copy, [6 x float]* %conv1_bias_copy, [2400 x float]* %conv2_filters_copy, [16 x float]* %conv2_bias_copy, [48000 x float]* %fc1_weights_copy, [120 x float]* %fc1_bias_copy, [10080 x float]* %fc2_weights_copy, [84 x float]* %fc2_bias_copy, [840 x float]* %fc3_weights_copy, [10 x float]* %fc3_bias_copy)
  call void @copy_back([1024 x float]* %0, [1024 x float]* %input_copy, i32* %predicted_class, i32* %predicted_class_copy, [150 x float]* %1, [150 x float]* %conv1_filters_copy, [6 x float]* %2, [6 x float]* %conv1_bias_copy, [2400 x float]* %3, [2400 x float]* %conv2_filters_copy, [16 x float]* %4, [16 x float]* %conv2_bias_copy, [48000 x float]* %5, [48000 x float]* %fc1_weights_copy, [120 x float]* %6, [120 x float]* %fc1_bias_copy, [10080 x float]* %7, [10080 x float]* %fc2_weights_copy, [84 x float]* %8, [84 x float]* %fc2_bias_copy, [840 x float]* %9, [840 x float]* %fc3_weights_copy, [10 x float]* %10, [10 x float]* %fc3_bias_copy)
