set moduleName fully_connected_Pipeline_VITIS_LOOP_58_2
set isTopModule 0
...
set C_modelName {fully_connected_Pipeline_VITIS_LOOP_58_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "sum", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln57", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln57 sc_in sc_lv 16 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln57", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "zext_ln57", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	input_r { ap_memory {  { input_r_address0 mem_address 1 9 }  { input_r_ce0 mem_ce 1 1 }  { input_r_q0 in_data 0 32 } } }
	sext_ln56 { ap_none {  { sext_ln56 in_data 0 62 } } }
	zext_ln57 { ap_none {  { zext_ln57 in_data 0 16 } } }
