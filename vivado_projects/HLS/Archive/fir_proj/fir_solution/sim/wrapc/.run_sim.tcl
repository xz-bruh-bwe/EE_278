...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fir_TOP.autotvin.dat"
	set constFileTvOut       "fir_TOP.autotvout.dat"
	set constFileHdlTvIn     "fir_TOP.autohdltvin.dat"
	set constFileHdlTvOut    "fir_TOP.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
