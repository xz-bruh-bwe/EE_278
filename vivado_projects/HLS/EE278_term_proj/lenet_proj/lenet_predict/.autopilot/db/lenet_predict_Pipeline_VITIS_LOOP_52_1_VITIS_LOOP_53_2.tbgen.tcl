set moduleName lenet_predict_Pipeline_VITIS_LOOP_52_1_VITIS_LOOP_53_2
set isTopModule 0
...
set C_modelName {lenet_predict_Pipeline_VITIS_LOOP_52_1_VITIS_LOOP_53_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ conv1_output float 32 regular {array 4704 { 1 1 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
	{ pool1_output float 32 regular {array 1176 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv1_output_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "conv1_output", "role": "address0" }} , 
 	...
 	{ "name": "conv1_output_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "conv1_output", "role": "address1" }} , 
 	...
 	{ "name": "conv1_output_address2", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "conv1_output", "role": "address2" }} , 
 	...
 	{ "name": "conv1_output_address3", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "conv1_output", "role": "address3" }} , 
 	...
 	{ "name": "pool1_output_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "pool1_output", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	conv1_output { ap_memory {  { conv1_output_address0 mem_address 1 13 }  { conv1_output_ce0 mem_ce 1 1 }  { conv1_output_q0 mem_dout 0 32 }  { conv1_output_address1 MemPortADDR2 1 13 }  { conv1_output_ce1 MemPortCE2 1 1 }  { conv1_output_q1 MemPortDOUT2 0 32 }  { conv1_output_address2 MemPortADDR2 1 13 }  { conv1_output_ce2 MemPortCE2 1 1 }  { conv1_output_q2 MemPortDOUT2 0 32 }  { conv1_output_address3 MemPortADDR2 1 13 }  { conv1_output_ce3 MemPortCE2 1 1 }  { conv1_output_q3 in_data 0 32 } } }
	pool1_output { ap_memory {  { pool1_output_address0 mem_address 1 11 }  { pool1_output_ce0 mem_ce 1 1 }  { pool1_output_we0 mem_we 1 1 }  { pool1_output_d0 mem_din 1 32 } } }
}
