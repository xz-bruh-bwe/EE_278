set moduleName lenet_predict_Pipeline_VITIS_LOOP_72_2
set isTopModule 0
...
set C_modelName {lenet_predict_Pipeline_VITIS_LOOP_72_2}
...
set portList { 
	...
	{ pool2_output_address0 sc_out sc_lv 9 signal 0 } 
	{ pool2_output_ce0 sc_out sc_logic 1 signal 0 } 
	{ pool2_output_q0 sc_in sc_lv 32 signal 0 } 
	{ pool2_output_address1 sc_out sc_lv 9 signal 0 } 
	{ pool2_output_ce1 sc_out sc_logic 1 signal 0 } 
	{ pool2_output_q1 sc_in sc_lv 32 signal 0 } 
	{ sum_2_out sc_out sc_lv 32 signal 1 } 
	{ sum_2_out_ap_vld sc_out sc_logic 1 outvld 1 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1605", "Max" : "1605"}
	, {"Name" : "Interval", "Min" : "1605", "Max" : "1605"}
]}
...
set Spec2ImplPortList { 
	pool2_output { ap_memory {  { pool2_output_address0 mem_address 1 9 }  { pool2_output_ce0 mem_ce 1 1 }  { pool2_output_q0 mem_dout 0 32 }  { pool2_output_address1 MemPortADDR2 1 9 }  { pool2_output_ce1 MemPortCE2 1 1 }  { pool2_output_q1 in_data 0 32 } } }
