set moduleName lenet_predict_Pipeline_VITIS_LOOP_12_1
set isTopModule 0
...
set C_modelName {lenet_predict_Pipeline_VITIS_LOOP_12_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ max float 32 regular  }
	{ fc3_output float 32 regular {array 10 { 1 3 } 1 1 }  }
	{ max_1_out float 32 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ max_1_out sc_out sc_lv 32 signal 2 } 
	{ max_1_out_ap_vld sc_out sc_logic 1 outvld 2 } 
