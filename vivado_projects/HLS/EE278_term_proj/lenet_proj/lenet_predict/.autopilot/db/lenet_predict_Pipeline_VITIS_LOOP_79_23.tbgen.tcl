set moduleName lenet_predict_Pipeline_VITIS_LOOP_79_23
set isTopModule 0
...
set C_modelName {lenet_predict_Pipeline_VITIS_LOOP_79_23}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln76_2 int 62 regular  }
	{ fc2_output float 32 regular {array 84 { 1 1 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_74","offset": { "type": "dynamic","port_name": "input_74","bundle": "control_r"},"direction": "READONLY"},{"cName": "conv1_filters_74","offset": { "type": "dynamic","port_name": "conv1_filters_74","bundle": "control_r"},"direction": "READONLY"},{"cName": "conv1_bias_74","offset": { "type": "dynamic","port_name": "conv1_bias_74","bundle": "control_r"},},{"cName": "conv2_filters_74","offset": { "type": "dynamic","port_name": "conv2_filters_74","bundle": "control_r"},"direction": "READONLY"},{"cName": "conv2_bias_74","offset": { "type": "dynamic","port_name": "conv2_bias_74","bundle": "control_r"},},{"cName": "fc1_weights_74","offset": { "type": "dynamic","port_name": "fc1_weights_74","bundle": "control_r"},"direction": "READONLY"},{"cName": "fc1_bias_74","offset": { "type": "dynamic","port_name": "fc1_bias_74","bundle": "control_r"},},{"cName": "fc2_weights_74","offset": { "type": "dynamic","port_name": "fc2_weights_74","bundle": "control_r"},"direction": "READONLY"},{"cName": "fc2_bias_74","offset": { "type": "dynamic","port_name": "fc2_bias_74","bundle": "control_r"},},{"cName": "fc3_weights_74","offset": { "type": "dynamic","port_name": "fc3_weights_74","bundle": "control_r"},"direction": "READONLY"},{"cName": "fc3_bias_74","offset": { "type": "dynamic","port_name": "fc3_bias_74","bundle": "control_r"},}]}]} , 
 	{ "Name" : "sext_ln76_2", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "fc2_output", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln76_2 sc_in sc_lv 62 signal 1 } 
	{ fc2_output_address0 sc_out sc_lv 7 signal 2 } 
	{ fc2_output_ce0 sc_out sc_logic 1 signal 2 } 
	{ fc2_output_q0 sc_in sc_lv 32 signal 2 } 
	{ fc2_output_address1 sc_out sc_lv 7 signal 2 } 
	{ fc2_output_ce1 sc_out sc_logic 1 signal 2 } 
	{ fc2_output_q1 sc_in sc_lv 32 signal 2 } 
	{ sum_6_out sc_out sc_lv 32 signal 3 } 
	{ sum_6_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ grp_fu_909_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_909_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_909_p_opcode sc_out sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln76_2", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln76_2", "role": "default" }} , 
 	{ "name": "fc2_output_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "fc2_output", "role": "address0" }} , 
 	...
 	{ "name": "fc2_output_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "fc2_output", "role": "address1" }} , 
 	{ "name": "fc2_output_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fc2_output", "role": "ce1" }} , 
 	{ "name": "fc2_output_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fc2_output", "role": "q1" }} , 
 	...
 	{ "name": "grp_fu_909_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_909_p_opcode", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln76_2 { ap_none {  { sext_ln76_2 in_data 0 62 } } }
	fc2_output { ap_memory {  { fc2_output_address0 mem_address 1 7 }  { fc2_output_ce0 mem_ce 1 1 }  { fc2_output_q0 mem_dout 0 32 }  { fc2_output_address1 MemPortADDR2 1 7 }  { fc2_output_ce1 MemPortCE2 1 1 }  { fc2_output_q1 MemPortDOUT2 0 32 } } }
