...
entity array_add_AXI_LITE_s_axi is
generic (
...
end entity array_add_AXI_LITE_s_axi;
...
architecture behave of array_add_AXI_LITE_s_axi is
    ...
    constant ADDR_RESULT_BASE : INTEGER := 16#c0#;
    constant ADDR_RESULT_HIGH : INTEGER := 16#ff#;
    ...
    -- memory signals
    signal int_a_address0      : UNSIGNED(3 downto 0);
    signal int_a_ce0           : STD_LOGIC;
    signal int_a_q0            : UNSIGNED(31 downto 0);
    signal int_a_address1      : UNSIGNED(3 downto 0);
    ...
    signal int_b_address0      : UNSIGNED(3 downto 0);
    signal int_b_ce0           : STD_LOGIC;
    signal int_b_q0            : UNSIGNED(31 downto 0);
    signal int_b_address1      : UNSIGNED(3 downto 0);
    ...
    component array_add_AXI_LITE_s_axi_ram is
        generic (
    ...
    end component array_add_AXI_LITE_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_a
int_a : array_add_AXI_LITE_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_a_q1);
-- int_b
int_b : array_add_AXI_LITE_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_b_q1);
-- int_result
int_result : array_add_AXI_LITE_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "S2P",
     BYTES     => 4,
...
-- ----------------------- Memory logic ------------------
    ...
    int_a_address1       <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_b_address1       <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
    ...
    int_result_address1  <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
...
entity array_add_AXI_LITE_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity array_add_AXI_LITE_s_axi_ram;

architecture behave of array_add_AXI_LITE_s_axi_ram is
