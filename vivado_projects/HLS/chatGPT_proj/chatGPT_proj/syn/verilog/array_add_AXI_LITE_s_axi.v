...
// ==============================================================
`timescale 1ns/1ps
module array_add_AXI_LITE_s_axi
#(parameter
    ...
    input  wire [3:0]                    b_address0,
    input  wire                          b_ce0,
    output wire [31:0]                   b_q0,
    input  wire [3:0]                    result_address0,
...
localparam
    ...
    ADDR_B_BASE      = 8'h80,
    ADDR_B_HIGH      = 8'hbf,
    ADDR_RESULT_BASE = 8'hc0,
    ADDR_RESULT_HIGH = 8'hff,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg                           int_a_read;
    reg                           int_a_write;
    wire [3:0]                    int_b_address0;
    wire                          int_b_ce0;
    wire [31:0]                   int_b_q0;
    wire [3:0]                    int_b_address1;
    wire                          int_b_ce1;
    wire                          int_b_we1;
    wire [3:0]                    int_b_be1;
    wire [31:0]                   int_b_d1;
    ...
    reg                           int_b_read;
    reg                           int_b_write;
    wire [3:0]                    int_result_address0;
    wire                          int_result_ce0;
    wire [3:0]                    int_result_be0;
    wire [31:0]                   int_result_d0;
    wire [3:0]                    int_result_address1;
    wire                          int_result_ce1;
...
assign int_a_address1      = ar_hs? raddr[5:2] : waddr[5:2];
...
assign int_b_address1      = ar_hs? raddr[5:2] : waddr[5:2];
...
assign int_result_address1 = ar_hs? raddr[5:2] : waddr[5:2];
...
module array_add_AXI_LITE_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
