...
$(ObjDir)/array_add_tb.cpp_pre.cpp.tb.o : array_add_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling array_add_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/array_add.cpp_pre.cpp.tb.o : array_add.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling array_add.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
