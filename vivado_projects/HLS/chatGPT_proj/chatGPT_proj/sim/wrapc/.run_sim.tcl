...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "array_add.autotvin.dat"
	set constFileTvOut       "array_add.autotvout.dat"
	set constFileHdlTvIn     "array_add.autohdltvin.dat"
	set constFileHdlTvOut    "array_add.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
