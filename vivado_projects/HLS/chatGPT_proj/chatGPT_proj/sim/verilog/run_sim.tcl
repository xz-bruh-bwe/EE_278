...
if {[file isfile array_add.autotvin.dat]} {
	file delete -force array_add.autotvin.dat
}

if {[file isfile array_add.autotvout.dat]} {
	file delete -force array_add.autotvout.dat
}
