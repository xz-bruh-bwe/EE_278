...
using hls::sim::Byte;
extern "C" void array_add(Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_array_add_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_result) {
...
std::vector<Byte<4>> __xlx_result__tmp_vec;
for (size_t i = 0; i < 10; ++i){
__xlx_result__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_result)[i]);
}
  int __xlx_size_param_result = 10;
  int __xlx_offset_param_result = 0;
  int __xlx_offset_byte_param_result = 0*4;
  // DUT call
  array_add(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_result__tmp_vec.data());
...
((Byte<4>*)__xlx_apatb_param_result)[i] = __xlx_result__tmp_vec[__xlx_offset_param_result+i];
}
}
