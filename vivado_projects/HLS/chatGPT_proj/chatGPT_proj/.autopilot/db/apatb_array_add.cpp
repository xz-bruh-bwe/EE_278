...
#define AUTOTB_TVOUT_a "../tv/cdatafile/c.array_add.autotvout_a.dat"
#define AUTOTB_TVIN_b "../tv/cdatafile/c.array_add.autotvin_b.dat"
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.array_add.autotvout_b.dat"
#define AUTOTB_TVIN_result "../tv/cdatafile/c.array_add.autotvin_result.dat"
#define AUTOTB_TVOUT_result "../tv/cdatafile/c.array_add.autotvout_result.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_result "../tv/rtldatafile/rtl.array_add.autotvout_result.dat"
...
extern "C"
void array_add_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_array_add_hw(void* __xlx_apatb_param_a, void* __xlx_apatb_param_b, void* __xlx_apatb_param_result)
{
#ifdef USE_BINARY_TV_FILE
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_result),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_result),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_result),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_result),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_result),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_result),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_result };
  port2.nbytes = { 40 };
  port2.offset = {  };
  port2.hasWrite = { true };
  ...
  try {
    ...
    array_add_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_result);
