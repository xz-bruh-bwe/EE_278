...
using hls::sim::Byte;
extern "C" void neuron(volatile void *, Byte<4>*);
extern "C" void apatb_neuron_hw(volatile void * __xlx_apatb_param_y, volatile void * __xlx_apatb_param_x) {
...
__xlx_x__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_x)[i]);
  ...
  int __xlx_size_param_x = 6;
  int __xlx_offset_param_x = 0;
  int __xlx_offset_byte_param_x = 0*4;
  // DUT call
  neuron(__xlx_apatb_param_y, __xlx_x__tmp_vec.data());
