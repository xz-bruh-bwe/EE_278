...
# 2 "<built-in>" 2
# 1 "HLS_Code/neuron.c" 2
# 1 "HLS_Code/neuron.h" 1
# 12 "HLS_Code/neuron.h"
...
__attribute__((sdx_kernel("neuron", 0))) void neuron (
  data_t *y,
  data_t x[6]
  );
# 2 "HLS_Code/neuron.c" 2

__attribute__((sdx_kernel("neuron", 0))) void neuron (
  data_t *y,
  data_t x[6]
  ) {
#line 17 "C:/Users/Baron/Desktop/EE_278_Repo/EE_278/vivado_projects/HLS/neuron/neuron/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=neuron
# 6 "HLS_Code/neuron.c"
