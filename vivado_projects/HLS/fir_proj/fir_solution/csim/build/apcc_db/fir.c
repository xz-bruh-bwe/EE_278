...
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds [11 x i32]* @aesl_internal_fir_TOP.c, i64 0, i64 %%9, !dbg !4 for 0x%I64xth hint within @fir_TOP  --> \n", ++aesl_llvm_cbe_31_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load i32* %%11, align 4, !dbg !4 for 0x%I64xth hint within @fir_TOP  --> \n", ++aesl_llvm_cbe_32_count);
  llvm_cbe_tmp__9 = (unsigned int )*llvm_cbe_tmp__8;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = mul nsw i32 %%12, %%8, !dbg !4 for 0x%I64xth hint within @fir_TOP  --> \n", ++aesl_llvm_cbe_33_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = add nsw i32 %%13, %%2, !dbg !4 for 0x%I64xth hint within @fir_TOP  --> \n", ++aesl_llvm_cbe_34_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = add nsw i32 %%storemerge1, -1, !dbg !5 for 0x%I64xth hint within @fir_TOP  --> \n", ++aesl_llvm_cbe_39_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%18, i32* %%y, align 4, !dbg !3 for 0x%I64xth hint within @fir_TOP  --> \n", ++aesl_llvm_cbe_43_count);
