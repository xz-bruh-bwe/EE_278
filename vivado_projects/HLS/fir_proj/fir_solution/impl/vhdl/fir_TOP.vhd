...
architecture behav of fir_TOP is 
    ...
    "fir_TOP_fir_TOP,hls_ip_2023_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12t-csg325-1Q,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.860000,HLS_SYN_LAT=16,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=524,HLS_SYN_LUT=315,HLS_VERSION=2023_1}";
    ...
    component fir_TOP_mul_7s_32s_32_2_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component fir_TOP_shift_reg_RAM_AUTO_1R1W IS
    generic (
        DataWidth : INTEGER;
    ...
    component fir_TOP_c_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component fir_TOP_fir_io_s_axi IS
    generic (
    ...
    component fir_TOP_flow_control_loop_pipe IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    shift_reg_U : component fir_TOP_shift_reg_RAM_AUTO_1R1W
    generic map (
        DataWidth => 32,
        AddressRange => 11,
        AddressWidth => 4)
    ...
    c_U : component fir_TOP_c_ROM_AUTO_1R
    generic map (
        DataWidth => 7,
        AddressRange => 11,
        AddressWidth => 4)
    ...
    fir_io_s_axi_U : component fir_TOP_fir_io_s_axi
    generic map (
    ...
    mul_7s_32s_32_2_1_U1 : component fir_TOP_mul_7s_32s_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 7,
    ...
    flow_control_loop_pipe_U : component fir_TOP_flow_control_loop_pipe
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => ap_start,
