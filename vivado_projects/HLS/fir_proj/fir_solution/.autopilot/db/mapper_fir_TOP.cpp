...
using hls::sim::Byte;
extern "C" void fir_TOP(volatile void *, int);
extern "C" void apatb_fir_TOP_hw(volatile void * __xlx_apatb_param_y, int __xlx_apatb_param_x) {
using hls::sim::createStream;
  // DUT call
  fir_TOP(__xlx_apatb_param_y, __xlx_apatb_param_x);
}
