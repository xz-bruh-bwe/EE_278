...
void fir(signed int *llvm_cbe_y, signed int llvm_cbe_x);


/* Global Variable Definitions and Initialization */
static signed int aesl_internal_fir_OC_c[11] = { 0u, 4294967286u, 4294967287u, 23u, 56u, 63u, 56u, 23u, 4294967287u, 4294967286u, 0u };
...
llvm_cbe_tmp__14:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge1 = phi i32 [ 10, %%0 ], [ %%15, %%4  for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_storemerge1_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = phi i32 [ 0, %%0 ], [ %%14, %%4  for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_19_count);
...
llvm_cbe_tmp__15:
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = add nsw i32 %%storemerge1, -1, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_24_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = sext i32 %%5 to i64, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_25_count);
  llvm_cbe_tmp__3 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds [11 x i32]* @aesl_internal_fir.shift_reg, i64 0, i64 %%6, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_26_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load i32* %%7, align 4, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_27_count);
  llvm_cbe_tmp__5 = (unsigned int )*llvm_cbe_tmp__4;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = sext i32 %%storemerge1 to i64, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_28_count);
  llvm_cbe_tmp__6 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = getelementptr inbounds [11 x i32]* @aesl_internal_fir.shift_reg, i64 0, i64 %%9, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_29_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%8, i32* %%10, align 4, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_30_count);
  *llvm_cbe_tmp__7 = llvm_cbe_tmp__5;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds [11 x i32]* @aesl_internal_fir.c, i64 0, i64 %%9, !dbg !4 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_31_count);
  llvm_cbe_tmp__8 = (signed int *)(&aesl_internal_fir_OC_c[(((signed long long )llvm_cbe_tmp__6))
#ifdef AESL_BC_SIM
 % 11
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__6) < 11)) fprintf(stderr, "%s:%d: warning: Read access out of array 'aesl_internal_fir.c' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load i32* %%11, align 4, !dbg !4 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_32_count);
  llvm_cbe_tmp__9 = (unsigned int )*llvm_cbe_tmp__8;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = mul nsw i32 %%12, %%8, !dbg !4 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_33_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = add nsw i32 %%13, %%2, !dbg !4 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_34_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = add nsw i32 %%storemerge1, -1, !dbg !5 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_39_count);
...
llvm_cbe__2e_thread:
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%x, i32* getelementptr inbounds ([11 x i32]* @aesl_internal_fir.shift_reg, i64 0, i64 0), align 16, !dbg !4 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_22_count);
...
llvm_cbe_tmp__16:
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = phi i32 [ %%2, %%.thread ], [ %%14, %%4  for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_42_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%18, i32* %%y, align 4, !dbg !3 for 0x%I64xth hint within @fir  --> \n", ++aesl_llvm_cbe_43_count);
