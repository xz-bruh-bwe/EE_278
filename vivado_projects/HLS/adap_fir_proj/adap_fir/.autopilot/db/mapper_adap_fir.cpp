...
using hls::sim::Byte;
extern "C" void adap_fir(volatile void *, float, float);
extern "C" void apatb_adap_fir_hw(volatile void * __xlx_apatb_param_y, float __xlx_apatb_param_x, float __xlx_apatb_param_d) {
using hls::sim::createStream;
  // DUT call
  adap_fir(__xlx_apatb_param_y, __xlx_apatb_param_x, __xlx_apatb_param_d);
}
