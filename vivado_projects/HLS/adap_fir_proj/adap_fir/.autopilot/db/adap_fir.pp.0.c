...
# 2 "<built-in>" 2
# 1 "HLS_Code/adap_fir.c" 2
# 1 "HLS_Code/adap_fir.h" 1
# 12 "HLS_Code/adap_fir.h"
...
__attribute__((sdx_kernel("adap_fir", 0))) void adap_fir(
  data_t *y,
  data_t x,
  data_t d
);
# 2 "HLS_Code/adap_fir.c" 2


coef_t coeffs[24] = {0, -10, -9, 23, 56, 63, 56, 23, -9, -10, 0};
...
#line 16 "C:/Users/Baron/Desktop/EE_278_Repo/EE_278/vivado_projects/HLS/adap_fir_proj/adap_fir/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=adap_fir
# 10 "HLS_Code/adap_fir.c"

#line 7 "C:/Users/Baron/Desktop/EE_278_Repo/EE_278/vivado_projects/HLS/adap_fir_proj/adap_fir/directives.tcl"
#pragma HLSDIRECTIVE TOP name=adap_fir
# 10 "HLS_Code/adap_fir.c"
...
#pragma HLS INTERFACE s_axilite bundle=fir_io port=d
 ...
 const coef_t learning_rate = 256;

  static data_t shift_reg[24] = {0};

  acc_t acc = 0;
  int i;


  Shift_Accum_Loop: for (i = 24 - 1; i >= 0; i--) {
    if (i == 0) {
      acc += x * coeffs[0];
      shift_reg[0] = x;
    } else {
  ...
  *y = acc;
  ...
  Coeff_Update_Loop: for (i = 0; i < 24; i++) {
