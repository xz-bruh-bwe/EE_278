set moduleName adap_fir_Pipeline_Shift_Accum_Loop
set isTopModule 0
...
set C_modelName {adap_fir_Pipeline_Shift_Accum_Loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ mul float 32 regular  }
	{ x float 32 regular  }
	{ acc_out float 32 regular {pointer 1}  }
	{ shift_reg float 32 regular {array 24 { 2 3 } 1 1 } {global 2}  }
	{ coeffs_1 float 32 regular {array 24 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "mul", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "coeffs_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ shift_reg_address0 sc_out sc_lv 5 signal 3 } 
	{ shift_reg_ce0 sc_out sc_logic 1 signal 3 } 
	{ shift_reg_we0 sc_out sc_logic 1 signal 3 } 
	{ shift_reg_d0 sc_out sc_lv 32 signal 3 } 
	{ shift_reg_q0 sc_in sc_lv 32 signal 3 } 
	{ coeffs_1_address0 sc_out sc_lv 5 signal 4 } 
	{ coeffs_1_ce0 sc_out sc_logic 1 signal 4 } 
	{ coeffs_1_q0 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "coeffs_1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "coeffs_1", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	shift_reg { ap_memory {  { shift_reg_address0 mem_address 1 5 }  { shift_reg_ce0 mem_ce 1 1 }  { shift_reg_we0 mem_we 1 1 }  { shift_reg_d0 mem_din 1 32 }  { shift_reg_q0 in_data 0 32 } } }
	coeffs_1 { ap_memory {  { coeffs_1_address0 mem_address 1 5 }  { coeffs_1_ce0 mem_ce 1 1 }  { coeffs_1_q0 mem_dout 0 32 } } }
}
